...
class NewBooking extends Customer{
  constructor(name, contactNumber, pickUp, dropOff, time, passengers, specialRequests){
    super(name, contactNumber)
    this._pickUp = pickUp
    this._dropOff = dropOff
    this._time = time
    this._passengers = passengers
    this._specialRequest = specialRequests
  }
  get pickUp(){
    return this._pickUp
  }
  ...
  confirmBooking(){
    console.log(`A booking has been made bla.....`)
  }
}
...
let margaret = new Customer ('Harley', '25', 'Margaret', '1231231234', 'full color', '123', '22/42/33', '12:30')
