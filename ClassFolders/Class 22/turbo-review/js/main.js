...
// let multipleWords = 'banana, tomato, fish, unicorn'
// let isApple = multipleWords.search('apple')
...
// // // //*Loops*
Create a function that takes an array of choices. Play the game x times where x is the number 
of choices in the array. Print the results of each game to the console.
